...
test1="$test1 select l_returnflag, l_linestatus, sum(l_quantity) as sum_qty, sum(l_extendedprice) as sum_base_price,  sum(l_extendedprice*(1-l_discount)) as sum_disc_price,  sum(l_extendedprice*(1-l_discount)*(1+l_tax)) as sum_charge,  avg(l_quantity) as avg_qty, avg(l_extendedprice) as avg_price,  avg(l_discount) as avg_disc, count(*) as count_order  from l_lineitem  where l_shipdate <= date '1998-12-01' - interval '90' day  group by l_returnflag, l_linestatus  order by l_returnflag, l_linestatus;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
...
query3 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 set hive.auto.convert.join=false; select l_orderkey, sum(l_extendedprice * (1 - l_discount)) as revenue, o_orderdate, o_shippriority from c_customer, o_orders, l_lineitem where c_mktsegment = 'BUILDING' and c_custkey = o_custkey and l_orderkey = o_orderkey and o_orderdate < date '1995-03-15' and l_shipdate > date '1995-03-15' group by l_orderkey, o_orderdate, o_shippriority order by revenue desc, o_orderdate limit 10; set hive.auto.convert.join=true;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query4 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 select o_orderpriority, count(*) as order_count from o_orders where o_orderdate >= date '1993-07-01' and o_orderdate < date '1993-07-01' + interval '3' month and exists (select * from l_lineitem where l_orderkey = o_orderkey and l_commitdate < l_receiptdate) group by o_orderpriority order by o_orderpriority;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query5 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 set hive.auto.convert.join=false; select n_name,sum(l_extendedprice * (1 - l_discount)) as revenue from c_customer, o_orders, l_lineitem, s_supplier, n_nation, r_region where c_custkey = o_custkey and l_orderkey = o_orderkey and l_suppkey = s_suppkey and c_nationkey = s_nationkey and s_nationkey = n_nationkey and n_regionkey = r_regionkey and r_name = 'ASIA' and o_orderdate >= date '1994-01-01' and o_orderdate < date '1994-01-01' + interval '1' year group by n_name order by revenue desc; set hive.auto.convert.join=true;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query6 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 select sum(l_extendedprice * l_discount) as revenue from l_lineitem where l_shipdate >= date '1994-01-01' and l_shipdate < date '1994-01-01' + interval '1' year and l_discount between 0.06 - 0.01 and 0.06 + 0.01 and l_quantity < 24;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query10 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 set hive.auto.convert.join=false; select c_custkey, c_name, sum(l_extendedprice * (1 - l_discount)) as revenue,c_acctbal,n_name,c_address,c_phone,c_comment from c_customer, o_orders, l_lineitem, n_nation where c_custkey = o_custkey and l_orderkey = o_orderkey and o_orderdate >= date '1993-10-01' and o_orderdate < date '1993-10-01' + interval '3' month and l_returnflag = 'R' and c_nationkey = n_nationkey group by c_custkey, c_name, c_acctbal,c_phone,n_name,c_address, c_comment order by revenue desc limit 20; set hive.auto.convert.join=true;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query12 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 set hive.auto.convert.join=false; select l_shipmode, sum(case when o_orderpriority = '1-URGENT' or o_orderpriority = '2-HIGH' then 1 else 0 end) as high_line_count,sum(case when o_orderpriority <> '1-URGENT' and o_orderpriority <> '2-HIGH' then 1 else 0 end) as low_line_count from o_orders, l_lineitem where o_orderkey = l_orderkey and l_shipmode in ('MAIL', 'SHIP') and l_commitdate < l_receiptdate and l_shipdate < l_commitdate and l_receiptdate >= date '1994-01-01' and l_receiptdate < date '1994-01-01' + interval '1' year group by l_shipmode order by l_shipmode; set hive.auto.convert.join=true;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query13 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 select c_count, count(*) as custdist from (select c_custkey,count(o_orderkey) as c_count from c_customer left outer join o_orders on c_custkey = o_custkey and o_comment not like '%special%requests%'group by c_custkey) as c_orders group by c_count order by custdist desc, c_count desc;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query14 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 select 100.00 * sum(case when p_type like 'PROMO%' then l_extendedprice * (1 - l_discount) else 0 end) / sum(l_extendedprice * (1 - l_discount)) as promo_revenue from l_lineitem, p_part where l_partkey = p_partkey and l_shipdate >= date '1995-09-01' and l_shipdate < date '1995-09-01' + interval '1' month;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query17 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 select sum(l_extendedprice) / 7.0 as avg_yearly from l_lineitem, p_part where p_partkey = l_partkey and p_brand = 'Brand#23' and p_container = 'MED BOX' and l_quantity < (select 0.2 * avg(l_quantity) from l_lineitem where l_partkey = p_partkey);"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query19 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 select sum(l_extendedprice* (1 - l_discount)) as revenue from l_lineitem, p_part where (p_partkey = l_partkey and p_brand = 'Brand#12' and p_container in ('SM CASE', 'SM BOX', 'SM PACK', 'SM PKG')and l_quantity >= 1 and l_quantity <= 1 + 10 and p_size between 1 and 5 and l_shipmode in ('AIR', 'AIR REG') and l_shipinstruct = 'DELIVER IN PERSON') or (p_partkey = l_partkey and p_brand = 'Brand#23' and p_container in ('MED BAG', 'MED BOX', 'MED PKG', 'MED PACK')and l_quantity >= 10 and l_quantity <= 10 + 10 and p_size between 1 and 10 and l_shipmode in ('AIR', 'AIR REG') and l_shipinstruct = 'DELIVER IN PERSON') or (p_partkey = l_partkey and p_brand = 'Brand#34' and p_container in ('LG CASE', 'LG BOX', 'LG PACK', 'LG PKG') and l_quantity >= 20 and l_quantity <= 20 + 10 and p_size between 1 and 15 and l_shipmode in ('AIR', 'AIR REG') and l_shipinstruct = 'DELIVER IN PERSON');"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
...
query20 () {
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 select s_name,s_address from s_supplier, n_nation where s_suppkey in (select ps_suppkey from ps_partsupp where ps_partkey in (select p_partkey from p_part where p_name like 'forest%') and ps_availqty > (select 0.5 * sum(l_quantity) from l_lineitem where l_partkey = ps_partkey and l_suppkey = ps_suppkey and l_shipdate >= date '1994-01-01' and l_shipdate < date '1994-01-01' + interval '1' year)) and s_nationkey = n_nationkey and n_name = 'CANADA' order by s_name;"
test1="$test1 select from_unixtime(unix_timestamp(current_timestamp)+7200);"
test1="$test1 !sh echo '--------------------------------------Finished QUERY $m.$i--------------------------------';"
}
