...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table c_customer stored as orc as select * from c_customer_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table l_lineitem stored as orc as select * from l_lineitem_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table n_nation stored as orc as select * from n_nation_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table r_region stored as orc as select * from r_region_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table o_orders stored as orc as select * from o_orders_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table p_part stored as orc as select * from p_part_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table s_supplier stored as orc as select * from s_supplier_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table ps_partsupp stored as orc as select * from ps_partsupp_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table c_customer_star stored as orc as select * from c_customer_tmp_star;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table lo_lineitem_orders_star stored as orc as select * from lo_lineitem_orders_tmp_star;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table s_supplier_star stored as orc as select * from s_supplier_tmp_star;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table p_part_star stored as orc as select * from p_part_star_tmp;"
echo ""
...
echo ""
/opt/hive/bin/beeline -u jdbc:hive2://localhost:10000 -e "set hive.execution.engine=mr; Create Table ps_partsupp_star stored as orc as select * from ps_partsupp_star_tmp;"
echo ""
